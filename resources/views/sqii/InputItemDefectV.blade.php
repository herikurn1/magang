...
@section('js')
    ...
    function item_defect() {
      ...
      $.ajax({
        type  : 'POST',
        url   : 'input_data_item_defect_c/show_data_item_defect',
        data  : {
    ...
    function delete_dt(kd_item_defect) {
        $.ajax({
          ...
          url: "input_data_item_defect_c/delete_dt",
          type: "POST",
    ...
    function save_process() {
      var kd_kategori = $('#kd_kategori').val();
      $('#kd_kategori_defect').val(kd_kategori);      
      ...
      if (kd_kategori == ''){
        ...
        $.ajax({
          data: data_all,
          url: "input_data_item_defect_c/save",
          type: "POST",
		...
		<div class="col-sm-12">
			<div class="card card-primary card-outline">
              ...
              <nav class="navbar justify-content-between">
                <a class="form-brand">
                  <h3 class="card-title">Input Data Item Defect</h3>
                </a>
