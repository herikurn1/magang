...
@section('js')
    ...
    function patern_cycle_time(kd_kawasan, kd_cluster, nm_kawasan, nm_clusterx, nm_sm, periode_1x, periode_2x, user_id, user_id_bawahan, namax, jml_unitx, jml_defect, total_defect, tot_unit, tahap_bangun){

      periode1 = periode_1x.replace("/", "-");
      periode2 = periode_2x.replace("/", "-");
      periode_1x = periode1.replace("/", "-");
      periode_2x = periode2.replace("/", "-");      
    
      window.open('{{ url("sqii/lap_patern_cycle_time_c/") }}'+'/'+kd_kawasan+'/'+kd_cluster+'/'+nm_kawasan+'/'+nm_clusterx+'/'+nm_sm+'/'+periode_1x+'/'+periode_2x+'/'+user_id+'/'+user_id_bawahan+'/'+nama+'/'+jml_unit+'/'+jml_defect+'/'+total_defect+'/'+tot_unit+'/'+session_user_id+'/'+tahap_bangun); 
    }
    ...
    function print_dt(){
        ...
        $.ajax({
          ...
          url: '{{ url("sqii/lap_formulasi_cycle_time_c/") }}/print_dt',
          type: "POST",
          dataType: 'html',
...
@section('content')
    <div class="col-sm-12">
      <div id="card_cycle_time" class="card card-primary card-outline">
        <div class="card-header">
          <h3 class="card-title">Tabel Formulasi Perhitungan Cycle Time </h3>
