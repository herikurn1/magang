...
@section('js')
    ...
    function formulasi_cycle_time(kd_kawasan, kd_cluster, nm_kawasan, nm_clusterx, nm_sm, periode_1x, periode_2x, user_id, user_id_bawahan, namax, jml_unitx, jml_defect, total_defect, tot_unit, tahap_bangun){
      ...
      window.open('{{ url("sqii/lap_formulasi_cycle_time_c/") }}'+'/'+kd_kawasan+'/'+kd_cluster+'/'+nm_kawasan+'/'+nm_clusterx+'/'+nm_sm+'/'+periode_1x+'/'+periode_2x+'/'+user_id+'/'+user_id_bawahan+'/'+nama+'/'+jml_unit+'/'+jml_defect+'/'+total_defect+'/'+tot_unit+'/'+session_user_id+'/'+tahap_bangun); 
    }
    ...
    function print_dt(){
      ...
      $.ajax({
        ...
        url: '{{ url("sqii/lap_cycle_time_c/") }}/print_dt',
        type: "POST",
        dataType: 'html',
    ...
    <div class="col-sm-12">
      <div id="card_cycle_time" class="" >
        <div class="card-header">
          <h3 class="card-title">Monitoring Cycle Time</h3>
