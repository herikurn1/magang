...
@section('js')
    ...
    function print_dt(){
        ...
        $.ajax({
          ...
          url: '{{ url("sqii/lap_detail_kinerja_qc_p35_orang_c/") }}/print_dt',
          type: "POST",
          dataType: 'html',
    ...
    function detail_kinerja_p3515_tahap(kd_kawasan1, kd_cluster1, nm_kawasan1, nm_cluster1, nm_sm1, periode_11, periode_21, user_id1,user_id_bawahan1, nama1, jml_unit1, jml_defect1, total_defect1, tot_unit1, kd_kategori_defect1,tahap_bangun){
      ...
      window.open('{{ url("sqii/lap_detail_kinerja_qc_P35_tahap_c/") }}'+'/'+kd_kawasan1+'/'+kd_cluster1+'/'+nm_kawasan1+'/'+nm_cluster1+'/'+nm_sm1+'/'+periode_11+'/'+periode_21+'/'+user_id1+'/'+user_id_bawahan1+'/'+nama1+'/'+jml_unit1+'/'+jml_defect1+'/'+total_defect1+'/'+tot_unit1+'/'+kd_kategori_defect1+'/'+session_user_id+'/'+tahap_bangun);
    }   
    ...
    <div class="col-sm-12">
      <div id="card_rekap_defect" class="card card-primary card-outline">
        <div class="card-header">
          <h3 class="card-title">Detail Kinerja QC P35 per orang</h3>
