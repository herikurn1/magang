...
<script>
    ...
    $(document).on('click', '.btn-proses', function(e){
        ...
        $.ajax({
            ...
            success: function (msg) { 
                $.each(msg, function(i, val){
                var tbl = '<form class="form-horizontal" id="frm_master" method="POST" action="prosespengajuan/progress_data" enctype="multipart/form-data">';
                    tbl +=      '<div class="row">'+
...
@section('content')
    <div class="card">
		...
		<div class="card-body">
            <table class="table table-sm text-nowrap table-menunggu" style="width: 100%;">
                <thead>
