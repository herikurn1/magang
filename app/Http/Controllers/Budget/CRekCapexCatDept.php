...
use App\Models\Budget\MRekCapexCatDept;

class CRekCapexCatDept extends Controller
{
	...
	public function index(Request $r)
	{
		...
		return view('budget.vRekCapexCatDept')->with('dt', $dt);
	}
	...
	public function check_role_budget(Request $r)
	{
		...
		$return 	= 'N';
		$q = MRekCapexCatDept::check_role_budget($user_id);
		foreach ($q as $row) {
	...
	public function search_detail(Request $r)
	{
		...
		$search_detail = MRekCapexCatDept::search_detail($kd_unit, $kd_departemen, $thn_anggaran);
		$detail = array(
	...
	public function search_chart(Request $r)
	{
		...
		$result = MRekCapexCatDept::search_chart($kd_unit, $kd_departemen, $thn_anggaran);
		$data = array();
