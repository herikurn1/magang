...
class LapDetailKinerjaP3515TahapC extends Controller
{
	...
	{ 
        ...
        $q = LapKinerjaP3515M::lap_detail_kualitas($kd_kawasan,$kd_cluster,$user_id_bawahan,$kd_kategori_defect,$periode_1,$periode_2,$tahap_bangun);
        ...
        foreach ($q as $row) {
            ...
            <tr>
                <td>'.$no++.'</td>
                <td>'.$row->BLOK.'/'.$row->NOMOR.'</td>
                <td style="text-align: center;">'.$row->NM_TAHAP.'</td>
                <td style="text-align: left;">'.$row->H_PEKERJAAN.'</td>
                <td style="text-align: left;">'.$row->NM_PEKERJAAN.'</td>
            </tr>';
		...
		if(isset($row_tbl)){
			return view('sqii.LapDetailKinerjaP3515TahapV')
				->with('dt', $dt)
				->with('tbl', $tbl);
		}
    ...
    public function print_dt(Request $r)
    {
        ...
        $q = LapKinerjaP3515M::lap_detail_kualitas($kd_kawasan,$kd_cluster,$user_id_bawahan,$kd_kategori_defect,$per_exp_1,$per_exp_2,$tahap_bangun);
