...
class LapDetailKinerjaQCP35OrangC extends Controller
{
	...
	{ 
		...
		$q = LapKinerjaQCP35M::lap_defect($kd_kawasan,$kd_cluster,$user_id_bawahan,$jml_unit,$periode_1,$periode_2,$tahap_bangun);
		...
		if(isset($row_tbl)){// LapDetailKualitasV LapDefectV2
			return view('sqii.LapDetailKinerjaQCP35OrangV')
				->with('dt', $dt)
				->with('tbl', $tbl);
		}
	}
	...
	public function print_dt(Request $r)
   {
		...
		$q = LapKinerjaQCP35M::lap_defect($kd_kawasan,$kd_cluster,$user_id_bawahan,$jml_unit,$per_exp_1,$per_exp_2,$tahap_bangun);
