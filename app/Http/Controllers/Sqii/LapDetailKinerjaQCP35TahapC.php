...
class LapDetailKinerjaQCP35TahapC extends Controller
{
	...
	{ 
        ...
        $q = LapKinerjaQCP35M::lap_detail_kualitas($kd_kawasan,$kd_cluster,$user_id_bawahan,$kd_kategori_defect,$periode_1,$periode_2,$tahap_bangun);
        ...
        foreach ($q as $row) {
            ...
            <tr>
                ...
                <td style="text-align: center;">'.$row->NM_PEKERJAAN.'</td>
            </tr>';
		...
		if(isset($row_tbl)){
			return view('sqii.LapDetailKinerjaQCP35TahapV')
				->with('dt', $dt)
				->with('tbl', $tbl);
		}
    ...
    public function print_dt(Request $r)
    {
        ...
        $q = LapKinerjaQCP35M::lap_detail_kualitas($kd_kawasan,$kd_cluster,$user_id_bawahan,$kd_kategori_defect,$per_exp_1,$per_exp_2,$tahap_bangun);
