...
class MEntryBudget extends Model
{
	...
	// public function count_data($user, $thn_anggaran, $kd_unit, $kd_lokasi)
	// {
	// 	$q = DB::select("
	// 					SELECT count(A.no_pengajuan) no_pengajuan, A.thn_anggaran, kd_unit, kd_lokasi, B.user_entry  from bc_mst_pengajuan A
	// 					inner join bc_dtl_pengajuan B
	// 					on A.no_pengajuan = B.no_pengajuan
	// 					where kd_unit= '".$kd_unit."'
	// 						and kd_lokasi= '".$kd_lokasi."'
	// 						and B.user_entry= '".$user."'
	// 						and A.thn_anggaran= '".$thn_anggaran."'
	// 					group by A.thn_anggaran, kd_unit, kd_lokasi, B.user_entry
    //                     ");
