...
class EntryJabatanPetugasM extends Model
{
    ...
    public static function get_staff($nik_petugas)
    {
    ...
    public static function nik_petugas($keyword)
    {
        ...
        ->where('a.KD_JABATAN', '<>', 'BI')
        ->where('a.KD_JABATAN', '<>', 'QC')
    ...
    public static function update_dt($kd_kawasan, $kd_jabatan, $nik_petugas, $flag_aktif, $user){
        $result = DB::connection('sqii2')
        ->table('SQII_USER')
    ...
    public static function simpan_bawahan($id_petugas, $id_bawahan, $nm_jabatan, $user){
