...
class LapRekapProgresM extends Model
{
    ...
    public static function search_dt($kd_kawasan,$kd_cluster,$kd_periode,$tahap_bangun)
    {
        $sql = "EXEC [SQII_N_SP_LAPORAN_REKAP_PROGRESS_V3] ";
        $sql.= "'".$kd_kawasan."',";
        $sql.= "'".$kd_cluster."',";
        $sql.= "'".$tahap_bangun."',";
        $sql.= "'".$kd_periode."'";
    ...
    public static function lap_defect($kd_kawasan,$kd_cluster,$kd_periode,$user_id)
    {
        $sql = "EXEC [SQII_N_SP_LAPORAN_DETAIL_PROGRESS_KONTRAKTOR] ";
        $sql.= "'".$kd_kawasan."',";
        $sql.= "'".$kd_cluster."',";
        $sql.= "'".$kd_periode."',";
        $sql.= "'".$user_id."'";
    ...
    public static function lap_detail_kualitas($kd_kawasan,$kd_cluster,$blok,$nomor,$kd_periode,$user_id)
    {
        $sql = "EXEC [SQII_N_SP_LAPORAN_DETAIL_AKTUAL_PROGRESS] ";
        $sql.= "'".$kd_kawasan."',";
        $sql.= "'".$kd_cluster."',";
        $sql.= "'".$blok."',";
        $sql.= "'".$nomor."',";
   ...
   public static function lap_detail_ageing_v2($kd_kawasan,$kd_cluster,$nik_petugas,$tot_unit,$periode_1,$periode_2,$tipe_ageing,$tahap_bangun)
    ...
    public static function data_periode($kd_kawasan,$kd_cluster,$tahap_bangun)
    {   $tahap = (empty($tahap_bangun)) ? 0 : $tahap_bangun;
        $sql = DB::connection('sqii2')
        ->select("
            select 
                KD_KAWASAN, KD_CLUSTER, KD_TAHAP, KD_PERIODE, NM_PERIODE, CONVERT(CHAR(10),A.TGL_AWAL,103) TGL_AWAL, CONVERT(CHAR(10),A.TGL_AKHIR,103) TGL_AKHIR, PROGRESS
            FROM SQII_RENCANA_PROGRESS A
            where 1=1
